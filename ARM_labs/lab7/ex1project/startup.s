...
calories 			RN   0 ; R0 -> matrix
quantity			RN   1 ; R1 -> new_matrix
c 					RN   2 ; 
q					RN   3
num					RN   4
...
ciclo_cal 		ldr r5, [calories, c,lsl #2]
				add c, c, #1
				ldr r6, [calories, c, lsl #2]
				add c, c, #1
				
				MOV q, #0
			
ciclo_quant		ldr r7, [quantity, q, lsl #2]
				cmp r5,r7
				addne q,q,#2
				bne ciclo_quant
				add q,q,#1
				ldr r8,[quantity,q,lsl #2]
				mla r10,r8,r6,r10
				subs num,num,#1
				bne ciclo_cal
